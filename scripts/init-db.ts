...
import type { DbNode, DbTemplate } from '../src/types/index.js';
...
async function initializeDatabase(): Promise<void> {
  ...
  try {
    ...
    if (!existsSync(nodesPath)) {
      ...
      const nodes: NodeInfo[] = JSON.parse(nodesData);
    ...
    const sampleTemplates: Array<Omit<DbTemplate, 'id'>> = [
      {
    ...
    console.log(`   AI Nodes: ${stats.aiNodes}`);
